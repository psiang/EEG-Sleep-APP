...
public class EcgView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static Queue<Integer> ecg0Datas = new LinkedList<Integer>();//脑电数据应该存放的地方
